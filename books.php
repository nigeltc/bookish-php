...
$sql = "SELECT id, name FROM book ORDER BY id";
...
if ($result->rowCount() > 0) {
	...
	echo "<td>".$row["id"]."</td>";
	echo "<td>".$row["name"]."</td>";
	echo "<td><a href=\"book_update.php?id=" . $row["id"] . "\">Update</a></td>";
	echo "<td><a href=\"book_delete.php?id=" . $row["id"] . "\">Delete</a></td>";
	echo "</tr>\n";
    }
    echo "</table>\n";
} else {
...
echo "<a href=\"book_add.php\">Add a new Book</a>\n";
echo "<br>\n";
